...
export const ListTrademarksQueryParams = zod.object({
  ...
  "caseType": zod.coerce.string().optional().describe('Filter by case type'),
  "subStage": zod.coerce.string().optional().describe('Filter by sub-stage'),
...
export const GetTrademarkStatsResponse = zod.object({
  "total": zod.number(),
  "recentlyModified": zod.number().optional(),
