      ...
      updateMutation.mutate(payload, {
        ...
        onError: (err: unknown) => {
          if (err instanceof ConflictError) {
            toast({
              title: "⚠ Conflict — Record Changed",
              description: "This record was modified by another user. Please reload and try again.",
              variant: "destructive",
            });
            return;
          }
      ...
      <div className="relative w-full max-w-3xl max-h-full bg-[#F0E8D0] border-2 border-[#0C0C0C] flex flex-col shadow-[8px_8px_0_#0C0C0C] overflow-hidden animate-in slide-in-from-bottom-4 duration-200">
        ...
        {!creating && isLoading ? (
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col flex-1 overflow-hidden">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      {...form.register("notes")}
                      rows={3}
                      className="w-full px-3 py-2 bg-white border-2 border-[#0C0C0C] font-mono text-sm focus:outline-2 focus:outline-[#C94A00] focus:outline-offset-0 resize-y"
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      />
                      <label
                        htmlFor="tm-image-upload"
                        className={`inline-flex items-center gap-2 h-10 px-4 border-2 border-[#0C0C0C] bg-white font-mono text-xs font-bold uppercase tracking-widest cursor-pointer hover:bg-[#E8DFC7] transition-colors ${uploading ? "opacity-50 pointer-events-none" : ""}`}
                      >
                      ...
                      {watchImage && (
                        <button
                          ...
                          className="inline-flex items-center gap-2 h-10 px-4 border-2 border-[#0C0C0C] bg-white font-mono text-xs font-bold uppercase tracking-widest hover:bg-[#E8DFC7]"
                        >
                    ...
                    {(imagePreview || watchImage) && (
                      <div className="mt-3 flex items-start gap-3">
                        {imagePreview ? (
                          ...
                          <div className="w-24 h-24 border-2 border-[#0C0C0C] bg-[#E8DFC7] flex items-center justify-center">
            ...
            {/* Footer actions */}
            <div className="shrink-0 flex items-center justify-between gap-3 px-6 py-4 border-t-2 border-[#0C0C0C] bg-[#E8DFC7]">
              <div>
                {!creating && (
                  <button
                    type="button"
                    ...
                    className="inline-flex items-center gap-2 h-10 px-4 border-2 border-[#CC0000] text-[#CC0000] font-mono text-xs font-bold uppercase tracking-widest hover:bg-[#CC0000] hover:text-white transition-colors disabled:opacity-40"
                  >
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  onClick={onClose}
                  disabled={isPending}
                  className="h-10 px-5 border-2 border-[#0C0C0C] font-mono text-xs font-bold uppercase tracking-widest hover:bg-white disabled:opacity-40"
                >
                  CANCEL
                </button>
                <button
                  type="submit"
                  disabled={isPending}
                  className="inline-flex items-center gap-2 h-10 px-5 bg-[#0C0C0C] text-[#F0E8D0] font-mono text-xs font-bold uppercase tracking-widest hover:bg-[#C94A00] transition-colors disabled:opacity-40"
                >
                  {isPending ? (
                    <>
